...
define config.name = _("Targeted Attack: The Game")
...
An educational game by Trend Micro 2015

{image=TM}

{a=https://www.trendmicro.com/vinfo/us/security/news/cyber-attacks/play-cio-in-targeted-attack-game}Post: Play as the Company CIO in this Targeted Attack Game{/a}

{a=http://targetedattacks.trendmicro.com/index.html}Play the game here{/a}
""")
...
define build.name = "TargetedAttackTheGame"
...
define config.save_directory = "TargetedAttackTheGame-1708488738"
